# -*- coding: utf-8 -*-
#
# bhp_appointment_helper documentation build configuration file, created by
...
project = u'bhp_appointment_helper'
...
htmlhelp_basename = 'bhp_appointment_helperdoc'
...
latex_documents = [
  ('index', 'bhp_appointment_helper.tex', u'bhp\\_appointment\\_helper Documentation',
...
man_pages = [
    ('index', 'bhp_appointment_helper', u'bhp_appointment_helper Documentation',
...
texinfo_documents = [
  ('index', 'bhp_appointment_helper', u'bhp_appointment_helper Documentation',
   u'erik van widenfelt', 'bhp_appointment_helper', 'One line description of project.',
   'Miscellaneous'),
]
