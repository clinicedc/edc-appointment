# -*- coding: utf-8 -*-
#
# bhp_appointment documentation build configuration file, created by
...
htmlhelp_basename = 'bhp_appointmentdoc'
...
latex_documents = [
  ('index', 'bhp_appointment.tex', u'bhp\\_appointment Documentation',
...
man_pages = [
    ('index', 'bhp_appointment', u'bhp_appointment Documentation',
...
texinfo_documents = [
  ('index', 'bhp_appointment', u'bhp_appointment Documentation',
   u'erik van widenfelt', 'bhp_appointment', 'One line description of project.',
   'Miscellaneous'),
]
